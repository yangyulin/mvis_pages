...
description: The files CamCalib writes — dual YAML, cam-IMU JSON, HTML reports, and Kalibr interop.
pageType: reference
wide: true
---
...
This is how a Kalibr calibration becomes a CamCalib starting point, and how a
CamCalib result goes back into a Kalibr-expecting pipeline.
...
[`camcalib apply-calib`](/guides/corrected-datasets/) writes a corrected ROS1
