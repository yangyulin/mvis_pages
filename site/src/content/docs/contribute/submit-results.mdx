...
method:
  ...
  open_source: true
  url_repo: https://github.com/.../MVIS
...
artifacts:
  report_html: reports/mvis__open_mvis_4imu4cam.html
  raw_yaml:    raw/mvis__open_mvis_4imu4cam.yaml
submitted:
  by: Your Name
  date: 2026-04-20
...
1. Fork [`yangyulin/mvis_pages`](https://github.com/yangyulin/mvis_pages) on GitHub.
